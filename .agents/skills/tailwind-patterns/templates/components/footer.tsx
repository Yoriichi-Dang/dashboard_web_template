...
export function SimpleFooter() {
  ...
  return (
    <footer className='border-border bg-muted/50 mt-auto border-t'>
          ...
          <div className='mx-auto max-w-2xl text-center'>
            ...
            <form className='mx-auto flex max-w-md gap-2'>
              <input
                ...
                className='bg-background border-border focus:ring-primary flex-1 rounded-md border px-4 py-2 focus:ring-2 focus:outline-none'
              />
              <button className='bg-primary text-primary-foreground hover:bg-primary/90 rounded-md px-6 py-2 whitespace-nowrap transition-colors'>
                Subscribe
              </button>
            </form>
          </div>
